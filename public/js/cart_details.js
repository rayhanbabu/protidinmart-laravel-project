    ...
    function fetchAll_check_out_count() {
      $.ajax({
          ...
          success: function(response) {
                   console.log(response);
            if (response.status == "success") {
                    $('#subtotal_amount').text(response.subtotal_amount+"TK");
     ...
     function fetchAll(){
      $.ajax({
        ...
        success: function(response) {
          ...
          <!-- Cart Item 1 -->
          <div
            class="cart_item shadow-lg bg-white p-4 flex items-center  -lg justify-between mb-1"
          >
            <!-- Image -->
            <div class="w-24 h-24">
              <img
            ...
            <div class="ml-4">
              ...
              <div class="flex items-center mt-2">
                ...
                <input
                  ...
                  min="1"
                  value="${item.qty}"
                  class="quantity-input w-16 p-1 border   mr-4"
                   data-id="${item.id}" 
                />
