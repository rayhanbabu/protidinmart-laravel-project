...
<div class="card mt-2 mb-2 shadow-sm">
   <div class="card-header">
       <div class="row ">
               <div class="col-8"> <h5 class="mt-0"> {{$district->name}} Upazila / Area @if(!$id) Add @else Edit @endif </h5></div>
                     <div class="col-2">
  ...
  <div class="card-body">    
  <form method="post" action="{{url('address/upazila/insert')}}"  class="myform"  enctype="multipart/form-data" >
         {!! csrf_field() !!}
